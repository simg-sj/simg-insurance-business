...
import Motorcycle from "@/assets/images/icon-motorcycle.png"
    ...
    return (
        <div>
            <header className={'bg-main-light px-20 py-16 text-white'}>
                ...
                <div className={'text-3xl mt-10'}>Hicar 플랫폼배달업자 보험</div>
                <div className={'text-4xl font-semibold mt-3 break-keep'}>배민커넥트 오토바이 시간제보험 일정액제</div>
            </header>
            <section className={'section'}>
                <div className={'icon-img'}>
                    <Image src={Motorcycle} alt={'오토바이'} width={150} height={100} className={'mr-10'}/>
                    <div className={'bg-gray-100 h-28 w-1'}></div>
                    <div className={'ml-5 w-1/2 ml-5 flex flex-col items-end'}>
                        <div className={'mb-2'}><span className={'text-style1'}>5시간</span> 초과
                            배달해도
                        </div>
                        <div className={'break-keep'}>하루 <span className={'text-style1'}>5,500원</span> 고정</div>
                    </div>
                </div>
            ...
            <section className={'section'}>
                ...
                <div className={'my-6'}>
                    <div className={'text-4xl font-semibold py-1'}>만 <span className={'text-main'}>21세 부터 69세</span> 까지,
                    </div>
            ...
            <section className={'section'}>
                ...
                <div className={'my-6'}>
                    <div className={'text-4xl font-semibold py-1'}>1분당 약 <span className={'text-main'}>11.84원</span> 씩
                        과금
                    </div>
                    <div className={'text-4xl font-semibold py-1'}>일 5시간 초과시 <span
                        className={'text-main'}>5,200원</span> 고정
                    </div>
                </div>
                <div>
                    <div className={'text-style2'}>* 예시 : 일 4시간 운행시 2.841원 과금 / 일 8시간 운행시
                        5,200원 과금
                    </div>
                </div>
            </section>
                ...
                <div className={'my-6 space-y-4'}>
                    ...
                    >
                        <div>
                            ...
                            <div className={'mt-3 font-light'}>본 심사는 보험대리점 (주)SIMG에서 (대리점 등록번호 : 2014110098)에서 진행합니다.
                            </div>
                        </div>
                    </Accordion>
                </div>
            ...
            >
                <button className={'btn-base btn-gray w-1/3'}
                        onClick = {() => {router.push(`${pathname}/inquiry`)}}>결과조회</button>
